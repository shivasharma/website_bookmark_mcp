  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        null,
        React.createElement("h1", { className: "title" }, "System Health"),
        React.createElement("p", { className: "sub" }, "Docker overview and API health from the old dashboard health workspace.")
      ),
      React.createElement(
        "div",
        null,
        React.createElement("a", { className: "btn", href: "/bookmarks" }, "Back to Bookmarks"),
        React.createElement("button", { className: "btn", onClick: refreshHealth, type: "button" }, "Refresh")
      )
    ),
    React.createElement(
      "section",
    ...
    React.createElement(
      ...
      React.createElement("p", { className: "sub" }, "Stack includes Nginx, app service, Postgres, and certbot. This page is read-only and designed for quick status checks.")
    )
  );
}
